...
class CalendarEx9 { 
	public static void main(String[] args) { 
		System.out.println("2023. 5. 31 :" + getDayOfWeek(2023, 5, 31)); //무슨 요일이냐 
		System.out.println("2012. 6. 1 :" + getDayOfWeek(2012, 6, 1)); 
		System.out.println("2014. 5. 1 - 2014.4.28 :" + dayDiff(2014,5,1,2014,4,28)); 
		System.out.println("2015. 6. 29 : "+convertDateToDay(2015, 6, 29)); //날짜를 숫자로
		System.out.println("735778 : "+convertDayToDate(735778)); //숫자를 날짜로 
	} 
